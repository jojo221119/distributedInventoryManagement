...
\iflang{de}{
Ich versichere hiermit, dass ich meine {\arbeit} mit dem Thema: {\itshape {\titel} -- {\untertitel} } selbstständig verfasst und keine anderen als die angegebenen Quellen und Hilfsmittel benutzt habe.
